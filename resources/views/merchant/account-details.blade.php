                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="form-floating">
                            <input type="text" name="acc_bank_name" id="acc_bank_name" class="form-control" value="@isset($account){{$account->acc_bank_name}}@endisset" placeholder="Bank Name" @isset($account) readonly @endisset>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-floating">
                            <input type="text" name="acc_account_number" id="acc_account_number" class="form-control" value="@isset($account){{$account->acc_account_number }}@endisset" placeholder="Account Number" @isset($account) readonly @endisset>
                            <label for="acc_account_number">Account Number <span class="text-danger">*</span></label>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="form-floating">
                            <input type="text" name="acc_ifsc_code" id="acc_ifsc_code" class="form-control" value="@isset($account){{$account->acc_ifsc_code}}@endisset" placeholder="IFSC Code" @isset($account) readonly @endisset>
