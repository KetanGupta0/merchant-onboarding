                                            ...
                                            <ul class="dropdown-menu" style="">
                                                ...
                                                @if ($merchant->merchant_is_verified == 'Not Approved')
                                                    <li><a class="dropdown-item approve" href="javascript:void(0);" data-id="{{ $merchant->merchant_id }}"><i
                                                               class="ri-check-fill text-muted me-2 align-bottom"></i>Approve</a></li>
                                                @elseif($merchant->merchant_is_verified == 'Approved')
                                                    <li><a class="dropdown-item revoke" href="javascript:void(0);" data-id="{{ $merchant->merchant_id }}"><i
                                                               class="ri-close-line text-muted me-2 align-bottom"></i>Revoke Approval</a></li>
                                                @endif
                                                <li><a class="dropdown-item delete" href="javascript:void(0);" data-id="{{ $merchant->merchant_id }}"><i
